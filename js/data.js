...
{"name":"Sonya","range":"S","id":108,"condition":"Recruit in B1 of your HQ after defeating her at Shasarazade."}
  ...
  "chapters": [
    ...
    },
    {
      ...
      "paragraphs": [
        ...
        {
          "type":"plain",
          "text":"Head to the lower-right of Gregminster to the Rune Shop and put the Fire Crystal on Cleo. To be able to actually use the Fire Rune, you'll need to head over to Marie's Inn and rest there to replenish your MP; you should be at least at level 4, so Cleo should have 2 available level 1 MP to use. If you don't rest, your MP won't be replenished, and you won't be able to use it."
        },
        {
          "type":"plain",
          "text":"Before going to Rockland, I recommend going south to Lenankamp and upgrading Gremio's and Cleo's weapons and armor, as well as fighting for a little while on the World Map before continuing, if you feel that you need to. When you're ready, head east of Gregminster to Rockland."
        }
    ...
    },
    {
      ...
      "paragraphs":[
        {
          "type":"note",
          "text":"Here in Rockland, there's a person named Marco. If you talk to Marco, you'll be able to play game where you guess which cup the coin is under. Place a 100 coin bet, then watch where the coin goes. Write down where it ends up, then repeat about 15 times, keeping track of where it lands. Quit and talk to Marco again; you have now written down the first 15 places that the coin ends up every time you restart the game. The trick is that the coin always follows the same pattern, no matter how much you bet, but only while Marco is in Rockland. If, for example, the coin lands Right, Left, Right, Middle... when you bet 100 bits, you can now bet 10,000, and the coin will still land, Right, Left, Right, Middle. Just remember, the coin follows the same pattern, no matter how much you bet. This works wonders if you play it long enough to get your pattern going to where you'll start rolling!"
        },
        {
          "type":"plain",
        ...
        {
          "type":"plain",
          "text":"Pick option 1, because Kanaan will say that we're going now anyway if you pick 2. Unless you need something, leave Rockland and head east to Mt. Seifu. "
        },
        {
          "type":"place",
          "text":"Mt. Seifu",
          "party": [
              ...
              "savepoints":["Before Varkas & Sydonia"],
              "bits":"1000",
              "items":[
                "Medicine",
                "Antique",
        ...
        {
            "type":"plain",
            "text":"Once inside, follow the path to a fork, where you'll head northeast and get the [_BOOTS_] and [_MEDICINE_] out of the two chests. Head west and north from there into the doorway, and in this room, you'll find many paths to take! First, move west and southwest into another area with an [_ANTIQUE_] in a chest, then go back and take the westernmost path north, which leads to [_1000 BITS_]!"
        },
        {
          "type":"plain",
          "text":"Back to the large room, take third path from the left (right-middle) up to a chest containing a [_DEFENSE RUNE PIECE_]. Personally, I always use these types of rune pieces on the Hero, since he's the only one in the game who's in your party 100% of the time. Go back and take the path beside the one you just came from (left-middle) to the next area. Keep going through this room to the next room as well."
        },
        {
          "type":"plain",
        ...
        {
          "type":"plain",
          "text":"After the battle, Kanaan will take the credit for beating them, then you'll capture them and automatically return to the entrance of Mt. Seifu. Leave this place and head back west to Rockland."
        },
        {
          "type":"place",
          "text":"Rockland",
        ...
        {
          "type":"plain",
          "text":"If you happened to talk to the kids near the mansion before going to Mt. Seifu, you will find some Imperial Soldiers stomping down one of them."
        },
        {
          "type":"choices",
          "items":[
    ...
    },
    {
      ...
      "recruits": [
        ...
        "paragraphs":[
          ...
          {
            "type":"plain",
            "text":"At this point, Ted will come in. He'll tell you that they think he still has the Soul Eater, so he suggests that everyone should escape while he uses himself as bait."
          },
          {
            "type":"choices",
            "items":[
          ...
          {
            "type":"plain",
            "text":"Choose option 2 to agree with him, since we have to protect the Soul Eater at all costs. They will head out through the kitchen door, while Ted stays with the Guard. In 300 years, you were the only true friend he ever had."
          },
          {
            "type":"plain",
          ...
          {
            "type":"plain",
            "text":"Pick either option, and the guard will take a closer look at you. They think that you are that 'fugitive' McDohl kid. Just as Cleo and Gremio get ready to fight them while you escape, a man named Viktor comes over to settle the whole thing. His thoughts; would fugitives still be hanging around here? C'mon, now."
          },
          {
            "type":"plain",
  ...
  "major":[
    {
      "id":1,
      "title":"Battle at Pannu Yakuta Castle",
    ...
    "facilities":[
  {
    ...
    "HQ Level": "",
    "Unlocked By": "62",
    "Description": "Ivanov will create a mural when you give him the ingredients."
  },
  {
    "Facility": "Blacksmith",
    "HQ Level": "",
    "Unlocked By": "74",
    "Description": "This facility can upgrade weapons to level 12."
  },
  {
    "Facility": "Blacksmith",
    "HQ Level": "",
    "Unlocked By": "79",
    "Description": "This facility can upgrade weapons to level 15."
  },
  {
    "Facility": "Bath",
    "HQ Level": "",
    "Unlocked By": "17",
    "Description": "A bathhouse where players can relax with companions."
  },
  {
    "Facility": "Appraiser",
    "HQ Level": "",
    "Unlocked By": "49",
    "Description": "Antiques marked with “?” can be appraised."
  },
  {
    "Facility": "Warehouse",
    "HQ Level": "1",
    "Unlocked By": "18",
    "Description": "Players can deposit and withdraw items here."
  },
  {
    "Facility": "Tool Shop",
    "HQ Level": "1",
    "Unlocked By": "11",
    "Description": "A store that carries miscellaneous items. This shop also carries items discovered at other shops during your travels."
  },
  {
    "Facility": "Teleport",
    "HQ Level": "1",
    "Unlocked By": "31",
    "Description": "Players can teleport to places they've already discovered"
  },
  {
    "Facility": "Tavern",
    "HQ Level": "1",
    "Unlocked By": "Sanchez",
    "Description": "Players can manage their party here."
  },
  {
    "Facility": "Tavern",
    "HQ Level": "1",
  ...
  {
    "Facility": "Stone Tablet of Promise",
    "HQ Level": "1",
    "Unlocked By": "9",
    "Description": "A facility that has existed from the beginning, players can check on their companions here."
  },
  {
    "Facility": "Inn",
    "HQ Level": "1",
    "Unlocked By": "12",
    "Description": "Players can pay a certain amount to pass a day. This also allows players to save their game."
  },
  {
    "Facility": "Gossip",
    "HQ Level": "1",
    "Unlocked By": "13",
    "Description": "This character gives information. These can be clues on where to go to progress the story."
  },
  {
    "Facility": "Elevator",
    "HQ Level": "1",
    "Unlocked By": "10",
    "Description": "Players can use this to move through floors."
  },
  {
    "Facility": "Blacksmith",
    "HQ Level": "1",
    "Unlocked By": "33",
    "Description": "This facility can upgrade weapons to level 9."
  },
  {
    "Facility": "Blacksmith",
    "HQ Level": "1",
    "Unlocked By": "16",
    "Description": "This facility can upgrade weapons to level 5."
  },
  {
    "Facility": "Chinchirorin",
    "HQ Level": "2",
    "Unlocked By": "29",
    "Description": "Players can play the mini-game 'Chinchirorin'. The maximum betting amount is 9900."
  },
  {
    "Facility": "Blinking Mirror",
    "HQ Level": "2",
    "Unlocked By": "45",
    "Description": "Players can teleport with the Blinking Mirror."
  },
  {
    "Facility": "Armor Shop",
    "HQ Level": "2",
    "Unlocked By": "46",
    "Description": "An armor shop that carries items discovered at other shops during your travels."
  },
  {
    "Facility": "Window Maker",
    "HQ Level": "3",
    "Unlocked By": "88",
    "Description": "Player's can change the design and color of windows here."
  },
  {
    "Facility": "Rune Master",
    "HQ Level": "3",
    "Unlocked By": "47",
    "Description": "Players can interact with this character to manage Runes."
  },
  {
    "Facility": "Phonologist",
    "HQ Level": "3",
    "Unlocked By": "72",
    "Description": "Players can change sound effects here with Sound Sets."
  },
  {
    "Facility": "Musician",
    "HQ Level": "3",
    "Unlocked By": "63",
    "Description": "Players can freely listen to the game's music."
  },
  {
    "Facility": "Library",
    "HQ Level": "3",
    "Unlocked By": "84",
    "Description": "Players can read at this facility."
  },
  {
    "Facility": "Correct Coin",
    "HQ Level": "3",
    "Unlocked By": "80",
    "Description": "Players can play the Correct Coin mini-game. Players can bet 100, 1000, and 10000."
  },
  {
    "Facility": "Auto Concentration",
    "HQ Level": "3",
    "Unlocked By": "65",
    "Description": "Players can play the 'Auto-concentration' mini-game."
  },
  {
    "Facility": "Blacksmith",
    "HQ Level": "4",
    "Unlocked By": "100",
    "Description": "This facility can upgrade weapons to level 16."
  }
    ]
  },
  // Master Collectibles Database
  collectibles: [
  {
   "id":"Astral Predications",
   "category":"Key Item",
   "desc":"What to give to Kraze on the first mission. Obtained from Leknaat on Magician's Island",
   "get":"Obtained from Chapter 1 event・You can obtain the Astral Predications from Leknaat in the Magician's Island."
  },
  {
   "id":"Binoculars",
   "category":"Special",
   "desc":"You will receive it from Ivanov when the mural is completed. It allows you to change the camera angles in battle.",
   "get":"Offer Paints to Ivanov ・You can obtain the Binoculars from Ivanov after successfully delivering all 7 paint types for him to complete the mural in Toran Lake Castle."
  },
  {
   "id":"Black Paint",
   "category":"Paint",
   "desc":"Item used to complete Ivanov's mural in the Toran Lake Castle",
   "get":"Treasure Chest ・Luikan's Hermitage "
  },
  {
   "id":"Blinking Mirror",
   "category":"Special",
   "desc":"Teleports to HQ when used on the field. Obtained when you recruit Hellion.",
   "get":"Recruit Hellion ・You can obtain the Blinking Mirror after recruiting Hellion."
  },
  {
   "id":"Blue Flower Seeds",
   "category":"Key Item",
   "desc":"Used to recruit Zen",
   "get":"Shop ・Rikon"
  },
  {
   "id":"Blue Paint",
  ...
  },
  {
   "id":"Blueprints",
   "category":"Key Item",
   "desc":"Blueprint given by Odessa. Must be delivered to Sarady.",
   "get":"Obtained from Story event ・You can obtain the Blueprints from Odessa in the Liberation Army base in Lenankamp."
  },
  {
   "id":"Dragon Incense",
   "category":"Special",
   "desc":"Can only be used during battle. Recovers around 50 HP for all party members",
   "get":"Roulette Wheel in Dwarves' Vault ・You can obtain the Dragon Incense by winning the roulette wheel found in the Dwarves' Vault."
  },
  {
   "id":"Earring",
   "category":"Key Item",
   "desc":"Earrings given by Odessa. Required to recruit Mathiu",
   "get":"Obtained from Story event ・You obtain the Earring after a story event in Story."
  },
  {
   "id":"Engine",
   "category":"Key Item",
   "desc":"Necessary to go to Liukan's Hermitage. Get it from the Kamandol",
   "get":"Obtained from Story event ・You can obtain the Engine from Kamandol as part of the story in Teien."
  },
  {
   "id":"Fake Orders",
   "category":"Key Item",
   "desc":"Necessary when infiltrating Soniere Prison. Created by Kimberly and Tesla",
  ...
  },
  {
   ...
   "category":"Paint",
   "desc":"Item used to complete Ivanov's mural in the Toran Lake Castle",
   "get":"Treasure Chest ・Neclord's Castle "
  },
  {
   "id":"Kirinji",
   "category":"Key Item",
   "desc":"Necessary to lure Lepant out. Obtained at Lepant's Mansion",
   "get":"Obtained in Lepant's Mansion ・You can obtain the Kirinji at the deepest level of Lepant's Mansion."
  },
  {
   "id":"Mathiu's Letter",
   "category":"Key Item",
   "desc":"Used to recruit Kimberly",
   "get":"Obtained from Story event ・You obtain Mathiu's Letter after a story event in Story where he asks you to deliver the letter to Kimberly in Antei."
  },
  {
   "id":"Moonlight Weed",
   "category":"Key Item",
   "desc":"One of the ingredients for an Antidote to the poison of sleep. Obtained from Seek Valley",
   "get":"Obtained in Seek Valley ・You can obtain the Moonlight Weed in the deepest part of Seek Valley."
  },
  {
   "id":"Nameless Urn",
   "category":"Key Item",
   "desc":"Used to recruit Jabba",
   "get":"Drop ・Holly Fairy"
  },
  {
   "id":"Old Book Vol. 1",
   "category":"Book",
   "desc":"Unlocks “The True Runes: Their Creation”",
   "get":"Treasure Chest ・Pannu Yakuta Castle "
  },
  {
   "id":"Old Book Vol. 2",
   "category":"Book",
   "desc":"Unlocks “Ancient Teachings”",
   "get":"Treasure Chest ・Cave of the Past "
  },
  {
   "id":"Old Book Vol. 3",
   "category":"Book",
   "desc":"Unlocks “Strategy of War”",
   "get":"Obtained in Qlon Temple ・You can obtain Old Book Vol. 3 by searching the bookshelf in Qlon Temple."
  },
  {
   "id":"Old Book Vol. 4",
   "category":"Book",
   "desc":"Unlocks “The Knights of the Dragon's Den”",
   "get":"Treasure Chest ・Dragon Knights' Fortress "
  },
  {
   "id":"Old Book Vol. 5",
   "category":"Book",
   "desc":"Unlocks “Craftsmen's Profiles”",
   "get":"Treasure Chest ・Dragon's Den "
  },
  {
   "id":"Old Book Vol. 6",
   "category":"Book",
   "desc":"Unlocks “Black List”",
   "get":"Treasure Chest ・Soniere Prison "
  },
  {
   "id":"Old Book Vol. 7",
   "category":"Book",
   "desc":"Unlocks “Antique Prices”",
   "get":"Treasure Chest ・Northern Checkpoint "
  },
  {
   "id":"Old Book Vol. 8",
   "category":"Book",
   "desc":"Unlocks “The Kalekka Tragedy”",
   "get":"Treasure Chest ・Kalekka "
  },
  {
   "id":"Old Book Vol. 9",
   "category":"Book",
   "desc":"Hidden library item found after collect the first 8 books",
   "get":"Complete Old Books Vol. 1 to 8 ・You can obtain the ninth book by pressing “◯・△・▢” at the same time when Old Books Vol. 1 to 8 are on the bookshelf."
  },
  {
   "id":"Opal",
   "category":"Key Item",
   "desc":"Used to recruit Esmeralda",
   "get":"Drop ・Nightmare"
  },
  {
   "id":"Pink Paint",
   "category":"Paint",
   "desc":"Item used to complete Ivanov's mural in the Toran Lake Castle",
   "get":"Treasure Chest ・Moravia "
  },
  {
   "id":"Red Flower Seeds",
   "category":"Key Item",
   "desc":"Used to recruit Zen",
   "get":"Shop ・Warriors' Village"
  },
  {
   "id":"Red Paint",
   "category":"Paint",
   "desc":"Item used to complete Ivanov's mural in the Toran Lake Castle",
   "get":"Treasure Chest ・Scarleticia Castle "
  },
  {
   "id":"Running Water Root",
   "category":"Key Item",
   "desc":"One of the dwarf treasures. Obtained from the Dwarves' Vault",
   "get":"Obtained in Dwarves' Vault ・You can obtain the Running Water Root at the deepest level of the Dwarves' Vault."
  },
  {
   "id":"Salt",
   "category":"Key Item",
   "desc":"Used to obtain Soy Sauce and recruit Sarah",
   "get":"Barter Event to Recruit Sarah ・You can obtain the Salt by trading the Yardstick in the barter event to recruit Sarah in Kirov."
  },
  {
   "id":"Soap",
   "category":"Key Item",
   "desc":"Used to recruit Sarah",
   "get":"Barter Event to Recruit Sarah ・You can obtain Soap by trading the Soy Sauce in the barter event to recruit Sarah in Kirov."
  },
  {
   "id":"Sound Rune",
   "category":"Key Item",
   "desc":"Used to recruit Melodye",
   "get":"Obtained in Kalekka ・This rune is obtained by picking up the Sound Crystal in Kalekka."
  },
  {
   "id":"Sound Set 0",
   "category":"Sound Set",
   "desc":"Item for changing window sound (Normal)",
   "get":"Treasure Chest ・Soniere Prison "
  },
  {
   "id":"Sound Set 1",
   "category":"Sound Set",
   "desc":"Item for changing window sound (Voice)",
   "get":"Treasure Chest ・Neclord's Castle "
  },
  {
   "id":"Sound Set 2",
   "category":"Sound Set",
   "desc":"Item for changing window sound (Animal)",
   "get":"Treasure Chest ・Seek Valley "
  },
  {
   "id":"Sound Set 3",
   "category":"Sound Set",
   "desc":"Item for changing window sound (Music)",
   "get":"Drop ・Siren"
  },
  {
   "id":"Soy Sauce",
   "category":"Key Item",
   "desc":"Used to obtain Soap and recruit Sarah",
   "get":"Barter Event to Recruit Sarah ・You can obtain the Soy Sauce by trading the Salt in the barter event to recruit Sarah in Kirov."
  },
  {
   "id":"Sugar",
   "category":"Key Item",
   "desc":"Used to obtain a Yardstick",
   "get":"Shop ・Kirov [Obtained in Kirov ・This item is purchased from the item store in Kirov."
  },
  {
   "id":"War Scroll",
   "category":"Key Item",
   "desc":"Used to recruit Hugo",
   "get":"Treasure Chest ・Cave of the Past"
  },
  {
   "id":"White Paint",
   "category":"Paint",
   "desc":"Item used to complete Ivanov's mural in the Toran Lake Castle",
   "get":"Treasure Chest ・Lepant's Mansion"
  },
  {
   "id":"Window Rune",
   "category":"Key Item",
   "desc":"Used to recruit Window",
   "get":"Treasure Chest ・Cave of the Past"
  },
  {
   "id":"Window Set 0",
   "category":"Window Set",
   "desc":"Items for changing window frame and color",
   "get":"Treasure Chest ・Secret Factory "
  },
  {
   "id":"Window Set 1",
   "category":"Window Set",
  ...
  },
  {
   "id":"Yardstick",
   "category":"Key Item",
   "desc":"Used to obtain Salt and recruit Sarah",
   "get":"Barter Event to Recruit Sarah ・You can obtain the Yardstick by trading Sugar in the barter event to recruit Sarah in Kirov."
  },
  {
   "id":"Yellow Flower Seeds",
   "category":"Key Item",
   "desc":"Used to recruit Zen",
   "get":"Shop ・Teien [Obtained in Teien ・These seeds can be purchased from the item store in Teien."
  },
  {
   "id":"Yellow Paint",
   "category":"Paint",
