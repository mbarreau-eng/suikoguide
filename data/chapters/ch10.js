guideData.chapters.push({
      ...
      "savepoints":["Inn"],
      "enemies":["Empire Soldier (PS1) / Imperial Soldier (Remaster) (sword #1)", "Empire Soldier (PS1) / Imperial Soldier (Remaster) (spear #1)"],
      "paragraphs":[
        {
          "type":"plain",
          "picture":"10/10-1.png",
        ...
        {
          "type":"choices",
          "items":["Help them, of course.","Wait. Let's see what's happening."]
        },
        {
          "type":"choices",
          "items":["Survivors of the Rebel Army.","Just some good guys passing by."]
        },
        {
          "type":"plain",
          "picture":"10/10-4.png",
        ...
        {
          "type":"plain",
          "text":"He was a coward; he wouldn't fight for what he believed in because of what war did to him, seeing people die due to his actions, but now, he decides to strive for what Odessa was striving for. When Gremio tries to give him the earring again, he says that you should keep it."
        },
        {
          "type":"choices",
          "items":["Why?","But Odessa..."]
        },
        {
          "type":"plain",
          "picture":"10/10-5.png",
        ...
        {
          "type":"choices",
          "items":["I can't do it.","I'll do it."]
        },
        {
          "type":"plain",
          "picture":"10/10-6.png",
        ...
        {
          "type":"plain",
          "text":"First, you need to go to Kaku so we can get a ride to the castle. Mathiu joins your party, but he can't go just yet because he has to get ready, as well as give the students plenty of homework. Shop around here if you need to (you can get a Water Crystal for Gremio if you really want to, but I'll keep the Prosperity Rune on him for a while), then leave Seika. Head southwest to Kaku."
        }
      ]
    });