guideData.chapters.push({
      ...
      "party":[
        ...
        {"name":"Viktor","level":"10"},
        {"name":"Cleo","level":"11"},
        {"name":"Odessa","level":"09"}
      ],
      "collectibles":["Earring"],
      "enemies":["Empire Soldier (PS1) / Imperial Soldier (Remaster) (sword #1)", "Empire Soldier (PS1) / Imperial Soldier (Remaster) (spear #1)", "Empire Soldier (PS1) / Imperial Soldier (Remaster) (bow #1)"],
      "paragraphs":[
        {
          "type":"note",
          "text":"If you have any more Water Rune Pieces, go to the Blacksmith and put them on Hero."
        },
        {
          "type":"plain",
          "picture":"8/8-1.png",
        ...
        {
          "type":"note",
          "text":"Odessa's death will unlock the level 1 spell of the Soul Eater; Deadly Fingertips."
        },
        {
          "type":"plain",
          "text":"Back at the Inn, we have to find a way to get to Seika, since the only way there is through the Fortress of Kwaba."        
        },
        {
          "type":"note",
          "text":"You won't be seeing Marco until much later in the game, so you may want to try to win as much money as you can. I would even max it out at 999999 if you have the time. Remember, bet 100 bits, track where the coin lands, win, then quit and repeat at the 10,000 bit level."
        },
        {
          "type":"plain",
          "text":"We're gonna go through Kwaba, so leave after all preparations are made, and head south of Lenankamp to Kwaba."
        }
      ]
    });