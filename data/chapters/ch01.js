guideData.chapters.push({
  ...
  savePoints: ["Hero's Desk", "Inn"],
  bits: ["100"],
  recruits: [
    { id: 1 },
    { id: null, name: "Ted", range: "M" },
    { id: 2 },
    { id: null, name: "Pahn", range: "S" },
    { id: 3 },
  ],
  party: [
    {
  ...
  paragraphs: [
    ...
    {
      type: "choices",
      items: ["Yes, Your Highness.", "I don't wanna."],
    },
    {
      type: "plain",
      picture: "1/1-6.png",
    ...
    },
    {
      ...
      bits: ["1000"],
      items: ["Medicine", "Wind Rune Piece", "Antique", "Medicine"],
      equipment: ["Circlet", "Gloves"],
      runes: ["Clone Crystal"],
    },
    {
      type: "plain",
    ...
    },
    {
      ...
      items: [],
      equipment: [],
      runes: ["Fortune Crystal *", "Prosperity Crystal *"],
    },
    {
      type: "plain",
      picture: "1/1-8.png",
