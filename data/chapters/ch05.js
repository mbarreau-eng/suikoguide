...
guideData.chapters.push({
      ...
      {
          "type":"plain",
          "text":" As soon as you enter, Viktor says that he needs to make some arrangements, and he'll take off. Before going to the Inn, I'm sure that you have extra money, so you should sharpen all of your weapons to level 5 and get the best equipment you can, if you don't have it already. Once you do that fun stuff, go to the Inn and talk to the Innkeeper and choose to stay the night."
      },
      {
        "type":"plain",
      ...
      {
        "type":"plain",
        "text":"Once they're together, he'll tell Odessa that he's one of the Mt. Seifu bandits, who only rob the Imperial scum. His bosses, Varkas and Sydonia, were captured and he needs their help to rescue them, since Grady has strung them up to die. Now it's time for a little judgment call."
      },
      {
        "type":"choices",
        "items":[
      ...
      {
        "type":"plain",
        "text":"When you're done preparing, leave Lenankamp, then head north and east back to Rockland."
      }
    ]
    });
