guideData.chapters.push({
      ...
      "paragraphs":[
        ...
        {
          "type":"note",
          "text":"If you went through Mt. Tigerwolf at the beginning of the game, just ignore the details below, since you should have already gotten the treasure here. Also, the Killer Slimes here drop Water Rune Pieces, which help your character recover HP every round when they're attached to the character's weapon."
        },
        {
          "type":"place",
          "text":"Mt. Tigerwolf",
        ...
        {
          "type":"plain",
          "text":"Head left to a fork; to the left is another chest with a [_WIND RUNE PIECE_], so get that, then go up under the bridge. Follow the path as it goes left across the bridge, then up to the next area."
        },
        {
          "type":"plain",
          "picture":"7/7-3.png",
        ...
        {
          "type":"plain",
          "text":"Choose option 2 to move on. Viktor asks what the tea is called, and he says that it's 'Robber's Tea.' At that point, everyone passes out and Ledon will go around and pick your pockets."
        },
        {
          "type":"plain",
          "picture":"7/7-6.png",
        ...
        {
          "type":"plain",
          "text":"Head up yet another screen, then move left, up, and right to grab the [_ANTIQUE_] before going up to the next screen. Go up a little, then open the chest to your left for another [_MEDICINE_]. Take the eastern path up and get the [_CLONE CRYSTAL_] out of the chest here, then head back and go up the western stairs. Continue up, but grab the [_1000 BITS_] to your right. Now head north back out to the World Map, then go north and enter Sarady."
        },
        {
          "type":"place",
          "text":"Sarady",
        ...
        {
          "type":"plain",
          "text":"Choose 1 and ask her about it. She's worried that she may not be able to live up to everyone else's hopes. She also wonders if you will go back to the Empire."
        },
        {
          "type":"choices",
          "items":[
        ...
        {
          "type":"note",
          "text":"Before entering Lenankamp, TAKE EVERYTHING OFF OF ODESSA."
        }
      ]
    });