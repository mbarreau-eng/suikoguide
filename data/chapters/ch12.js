guideData.chapters.push({
      ...
      "paragraphs":[
        ...
        {
          "type":"plain",
          "text":"Mathiu suggests that we recruit a man named Lepant in the town of Kouan, and after that, it'll be the next morning. Gremio comes in and joins you, saying that we need to talk to Mathiu, so go directly right of your room to the other side of the screen and talk to him. He says that if you say that Mathiu recommended him to join, Lepant will listen. Cleo and Viktor will join up with you, then you can choose who else to bring with you. You can always talk to Mathiu (or Sanchez later on) to switch party members."
        },
        {
          "type":"plain",
          "text":"Head to the bottom floor by taking the stairs to the north and exit through the south, then take the boat out to the World Map and head east to Kaku."
        },
        {
          "type":"place",
          "text":"Kaku",
          ...
          "party":[
            ...
            {"name":"Viktor","level":18},
            {"name":"Cleo","level":18},
            {"name":"Camille","level":18},
            {"name":"Luc","level":12},
          ]
        },
        {
        ...
        {
          "type":"plain",
          "text":"The bad thing is this; he heads straight to the castle. I STRONGLY recommend traveling all the way back to Headquarters just to put him in your battle party. He and Hero have a Unite attack that attacks ALL enemies for a LOT of damage (The Master Pupil Attack), which is great on 2 enemies or more, so you should be using this pretty much EVERY turn, unless there's only 1 enemy, then you should just use them to attack normally. Oh yeah, he also starts at level 21, and has a level 8 weapon, so go back to HQ and get him."
        },
        {
          "type":"plain",
        ...
        {
          "type":"plain",
          "text":"Now that Kai is in your party, head SOUTHEAST of Kouan to come to the Great Forest. We have 2 more people to recruit before going to Kouan."
        },
        {
          "type":"place",
          "text":"Great Forest",
        ...
        {
          "type":"note",
          "text":"Great Forest isn't only a town; go to the upper right of town to the next area. There are some TOUGH enemies here; it's also a very good place to level up if you're at a lower level, because the enemies we're going to encounter in Kouan are tough AND annoying, so I strongly recommend leveling up to around 20 (A battle with 6 Kobolds put Luc from 13 to 19). Make sure to SAVE before doing anything, though. Once you're done here, head northwest to Kouan."
        }
      ]
    });