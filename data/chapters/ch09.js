guideData.chapters.push({
      ...
      "paragraphs":[
        ...
        {
          "type":"choices",
          "items":["Masamune.","Piisuke.","Schtolteheim Reinbach IV."]
        },
        {
          "type":"plain",
        ...
        {
          "type":"plain",
          "text":"Ain Gide will decide to let you pass, since McDohl's son wouldn't be dressed like a beggar. As you pass by him, he'll mention to you to take good care of your father... (Yeah, he knows...)"
        },
        {
          "type":"plain",
        ...
        {
          "type":"choices",
          "items":["Unforgivable!","I understand, Gremio."]
        },
        {
          "type":"plain",
          "picture":"9-1.png",
        ...
        },
        {
          ...
          "text": "World Map",
          "places": [
            "S. Kwaba","Seika","Kaku","Kouan","W. Great Forest","E. Garan Area"
          ],
          "enemies":["Beast Commander","Flying Squirrel","Killer Rabbit (PS1) / Killer Bunny (Remaster)","Roc"]
        },
        {
          "type":"plain",
          "text":"Feel free to walk around and fight if you want to level up a couple of times, but when you're ready, make your way south to Seika."
        },
        {
          "type":"note",
          "text":"You might be able to get a Phero Crystal from the Beast Commander. Those babies sell for 25,000 Bits!"
        }
      ]
    });